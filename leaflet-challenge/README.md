...
Resources
* Professor Melissa Ingle市 Providing guidance and support throughout the project.
* Cassidy Cruz市 Assisting with discussions and feedback on data analysis.
* ChatGPT市 AI assistant for answering questions and providing coding suggestions.
* Xpert Learning Assistant市 Supplementary resource for learning and problem-solving.
Acknowledgments
This project leverages the following tools and technologies:
* Leaflet.js市 for creating the interactive map.
* D3.js市 for fetching and processing GeoJSON data.
* OpenStreetMap市 for providing the map tiles.

Contributors
* Project by Edward (or your name).
